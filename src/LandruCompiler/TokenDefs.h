...
TOKEN_DECL(New,				"new"		)
TOKEN_DECL(On,				"on"		)
TOKEN_DECL(Repeat,			"repeat"	)
TOKEN_DECL(Require,			"require"	)
TOKEN_DECL(State,			"state"		)
TOKEN_DECL(Tick,			"tick"		)
TOKEN_DECL(Symbols,			"symbols"	)
TOKEN_DECL(Generator,		"generator"	)
TOKEN_DECL(Exec,			"exec"		)
TOKEN_DECL(Lib,				"lib"		)
TOKEN_DECL(Array,			"array"		)
